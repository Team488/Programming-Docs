      ...
      '/curriculum/': [
        {
          ...
          items: [
            ...
            { text: 'Intermediate Java', link: '/curriculum/04-intermediate-java' },
            { text: 'Git & GitHub Desktop', link: '/curriculum/05-git-github' },
          ],
        },
        {
          text: 'Robot Fundamentals',
          items: [
            { text: 'Robot Architecture', link: '/curriculum/06-robot-architecture' },
            { text: 'Electrical Contract', link: '/curriculum/07-electrical-contract' },
